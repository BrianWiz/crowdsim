...
pub const SPATIALIZATION_CELL_SIZE: f32 = 10.0;
pub const SPATIALIZATION_GRID_CELLS_PER_AXIS: usize =
    (ARENA_SIZE / SPATIALIZATION_CELL_SIZE) as usize;
...
pub const SYNC_RELIABLY: bool = false;
